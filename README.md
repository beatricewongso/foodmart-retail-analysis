...
### Customer Behavior
- Customers return 3.68 times on average and buy 13 items per visit; the customer base are habitual, purposeful shoppers
- 98% retention rate once a customer makes their first purchase, but 46% of registered members have never bought anything, making first-purchase conversion the biggest challenge
- The most valuable customers are large, modest-income families who keep coming back
...
- Active rates and margins are nearly identical across all tiers 
...
- Products that sell the most carry below-average margins; slow movers carry above-average margins 
